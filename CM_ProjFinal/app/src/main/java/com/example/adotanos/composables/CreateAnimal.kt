...
fun PaginaCriarAnimal(
    ...
    var animalIdade by remember { mutableStateOf("") }
    var animalSexo by remember { mutableStateOf("") }
    var animalLocalidade by remember { mutableStateOf("") }
    var animalTipo by remember { mutableStateOf("") }
    var animalDescricao by remember { mutableStateOf("") }
    var animalImagemId by remember { mutableIntStateOf(-1) }
    var contactoEmail by remember { mutableStateOf("") }
    var contactoTele by remember { mutableStateOf("") }
    ...
    Column(
        ...
        Text(text = "Registar um animal para adoção:", modifier = Modifier.padding(8.dp), fontWeight = FontWeight.SemiBold)
        ...
        Button(
            onClick = {
                ...
                if (animalNome.isEmpty() ||animalIdade.isEmpty() ||animalSexo.isEmpty() ||
                    ...
                    RepositorioFirebase.addAnimal(Animal(
                        nome = animalNome,
                        idade = animalIdade,
                        sexo = animalSexo,
                    ...
                    Toast.makeText(context, "Animal adicionado.", Toast.LENGTH_SHORT).show()
                }

                      },
            modifier = Modifier.padding(top = 20.dp, bottom = 20.dp)) {
            Text(text = "Adicionar animal")
        }
    }
}